...
class Settings(BaseSettings):
    ...
    hls_prebuffer_segments: int = 2  # Number of segments to pre-buffer ahead.
    hls_prebuffer_cache_size: int = 10 # Maximum number of segments to cache in memory.
    hls_prebuffer_max_memory_percent: int = 50 # Maximum percentage of system memory to use for HLS pre-buffer cache.
    hls_prebuffer_emergency_threshold: int = 80  # Emergency threshold percentage to trigger aggressive cache cleanup.
    enable_dash_prebuffer: bool = true # Whether to enable DASH pre-buffering for improved streaming performance.
    dash_prebuffer_segments: int = 2  # Number of segments to pre-buffer ahead.
    dash_prebuffer_cache_size: int = 10  # Maximum number of segments to cache in memory.
    dash_prebuffer_max_memory_percent: int = 50  # Maximum percentage of system memory to use for DASH pre-buffer cache.
    dash_prebuffer_emergency_threshold: int = 80  # Emergency threshold percentage to trigger aggressive cache cleanup.
